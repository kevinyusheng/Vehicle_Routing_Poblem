...
class DRL4TSP(nn.Module):
    ...
    def forward(self, static, dynamic,transfer_correspond,render_record, decoder_input=None, last_hh=None):  ###transfer_correspond
        """
        Parameters
        ----------
        ...
        for _ in range(max_steps):
            ...
            if self.update_fn is not None:
                ...
                dynamic = self.update_fn(dynamic, ptr.data, transfer_correspond,render_record)   ###transfer_correspond
                dynamic_hidden = self.dynamic_encoder(dynamic)
